...
export default function Board({ board, onCellClick, winningLine }) {
  return (
    <div
      className="grid grid-cols-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl overflow-hidden"
      style={{ width: "min(288px, 72vmin)", height: "min(288px, 72vmin)" }}
    >
